...
my $make_bed_around_RE_site_pl = '/vol1/agis/huangsanwen_group/lihongbo/software/LACHESIS-master/make_bed_around_RE_site.pl';
my $bedtools = '/vol1/agis/huangsanwen_group/lihongbo/software/longranger-2.1.6/bedtools/v2.21.0/bedtools';
my $samtools = '/vol1/agis/huangsanwen_group/wangxin/lihb/bin/samtools';
#my $mem = "16G";
